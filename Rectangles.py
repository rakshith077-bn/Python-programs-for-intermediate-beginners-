class Point:
    ...
    def print_point(p):
        ...
        print("The original rectangle's height is: ")
        print("width=%g, height=%g"%(box.width, box.height))

        center = find_center(box)
        print("The center of rectangle is given by: ")
        print(center)

        resize(box,50,70)
        print("Rectangle after resizeis ")
        print("width=%g, height=%g"%(box.width, box.height))

        center = find_center(box)
        print("The center of resized rectangle is given as: ")
        print(center)
